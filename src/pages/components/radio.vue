  ...
  <t-page class="p-4">
    <t-card role="mode">
      ...
      <t-card-body>
        ...
        <t-radio-group v-model="selection" :role="role">
          <t-radio value="disabled" disabled>Disabled</t-radio>
          <t-radio value="outline" variant="outline">Outline</t-radio>
          <t-radio value="fill" variant="fill">Fill</t-radio>
        </t-radio-group>
      </t-card-body>
    </t-card>
  </t-page>
